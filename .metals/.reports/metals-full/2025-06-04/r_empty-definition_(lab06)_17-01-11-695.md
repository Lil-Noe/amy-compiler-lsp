error id: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala:scallion/Parsing#UnexpectedEnd.
file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala
empty definition using pc, found symbol in pc: scallion/Parsing#UnexpectedEnd.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -amyc/ast/NominalTreeModule.UnexpectedEnd.
	 -amyc/ast/NominalTreeModule.UnexpectedEnd#
	 -amyc/ast/NominalTreeModule.UnexpectedEnd().
	 -amyc/utils/UnexpectedEnd.
	 -amyc/utils/UnexpectedEnd#
	 -amyc/utils/UnexpectedEnd().
	 -Tokens.UnexpectedEnd.
	 -Tokens.UnexpectedEnd#
	 -Tokens.UnexpectedEnd().
	 -TokenKinds.UnexpectedEnd.
	 -TokenKinds.UnexpectedEnd#
	 -TokenKinds.UnexpectedEnd().
	 -scallion/UnexpectedEnd.
	 -scallion/UnexpectedEnd#
	 -scallion/UnexpectedEnd().
	 -Implicits.UnexpectedEnd.
	 -Implicits.UnexpectedEnd#
	 -Implicits.UnexpectedEnd().
	 -ctx/reporter/UnexpectedEnd.
	 -ctx/reporter/UnexpectedEnd#
	 -ctx/reporter/UnexpectedEnd().
	 -UnexpectedEnd.
	 -UnexpectedEnd#
	 -UnexpectedEnd().
	 -scala/Predef.UnexpectedEnd.
	 -scala/Predef.UnexpectedEnd#
	 -scala/Predef.UnexpectedEnd().
offset: 12581
uri: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala
text:
```scala
package amyc
package parsing
...
object Parser extends Pipeline[Iterator[Token], Program] with Parsers {
  ...
  override def run(ctx: Context)(tokens: Iterator[Token]): Program = {
    ...
    parser(tokens) match {
      ...
      case Unexpec@@tedEnd(rest)  => fatal("Unexpected end of input.")
