error id: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala:scallion/Parsing#UnexpectedToken.
file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala
empty definition using pc, found symbol in pc: scallion/Parsing#UnexpectedToken.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -amyc/ast/NominalTreeModule.UnexpectedToken.
	 -amyc/ast/NominalTreeModule.UnexpectedToken#
	 -amyc/ast/NominalTreeModule.UnexpectedToken().
	 -amyc/utils/UnexpectedToken.
	 -amyc/utils/UnexpectedToken#
	 -amyc/utils/UnexpectedToken().
	 -Tokens.UnexpectedToken.
	 -Tokens.UnexpectedToken#
	 -Tokens.UnexpectedToken().
	 -TokenKinds.UnexpectedToken.
	 -TokenKinds.UnexpectedToken#
	 -TokenKinds.UnexpectedToken().
	 -scallion/UnexpectedToken.
	 -scallion/UnexpectedToken#
	 -scallion/UnexpectedToken().
	 -Implicits.UnexpectedToken.
	 -Implicits.UnexpectedToken#
	 -Implicits.UnexpectedToken().
	 -ctx/reporter/UnexpectedToken.
	 -ctx/reporter/UnexpectedToken#
	 -ctx/reporter/UnexpectedToken().
	 -UnexpectedToken.
	 -UnexpectedToken#
	 -UnexpectedToken().
	 -scala/Predef.UnexpectedToken.
	 -scala/Predef.UnexpectedToken#
	 -scala/Predef.UnexpectedToken().
offset: 12651
...
object Parser extends Pipeline[Iterator[Token], Program] with Parsers {
  ...
  override def run(ctx: Context)(tokens: Iterator[Token]): Program = {
    ...
    parser(tokens) match {
      ...
      case Unexpec@@tedToken(token, rest) =>
        fatal(
