error id: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala:`<none>`.
file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Parser.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -amyc/ast/NominalTreeModule.endPos.
	 -amyc/ast/NominalTreeModule.endPos#
	 -amyc/ast/NominalTreeModule.endPos().
	 -amyc/utils/endPos.
	 -amyc/utils/endPos#
...
object Parser extends Pipeline[Iterator[Token], Program] with Parsers {
  ...
  lazy val parameter: Syntax[ParamDef] =
    (identifierPos ~ delimiter(":") ~ typeTree) map { 
      case (id, startPos, endPos) ~ _ ~ tt => ParamDef(id, tt).setPos(startPos).setEndPos(@@endPos)
    }
    (identifierPos ~ ":" ~ typeTree).map {
      case (id,pos,endPos) ~ _ ~ tt => ParamDef(id, tt).setPos(pos).setEndPos(endPos)
    }
