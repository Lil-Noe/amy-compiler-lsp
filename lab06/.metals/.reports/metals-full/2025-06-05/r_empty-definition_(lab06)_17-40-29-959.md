error id: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Tokens.scala:`<none>`.
file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Tokens.scala
...
offset: 415
uri: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Tokens.scala
text:
```scala
package amyc
package parsing
...
sealed trait Token extends Positioned with Product {
  override def toString = {
    productPrefix + productIterator.mkString("(", ",", ")") + "(" + startPosition.withoutFile + ")"
  }
}

object Tokens {
  final case class KeywordToken(value: String) extends Token    // e.g. keyword "if"
  final case class IdentifierToken(name: String) exte@@nds Token  // e.g. variable name "x" 
