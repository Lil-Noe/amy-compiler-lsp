error id: file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Lexer.scala:silex/Source.
file:///C:/Users/lilia/Documents/EPFL/BA6/CLP/CS-320_Amy_LSP/lab06/src/amyc/parsing/Lexer.scala
empty definition using pc, found symbol in pc: silex/Source.
...
> { (cs, range) =>
  ...
  override def run(
    ...
    for (file <- files) {
      val source = S@@ource.fromFile(file.toString, SourcePositioner(file))
