error id: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(3).scala:`<none>`.
file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(3).scala
...
non-local guesses:
	 ...
	 -amyc/utils/Position#
	 -amyc/utils/Position().
	 -amyc/parsing/Position.
	 -amyc/parsing/Position#
	 -amyc/parsing/Position().
	 -amyc/analyzer/Position.
	 -amyc/analyzer/Position#
	 -amyc/analyzer/Position().
	 -amyc/ast/SymbolicTreeModule.Position.
	 -amyc/ast/SymbolicTreeModule.Position#
	 -amyc/ast/SymbolicTreeModule.Position().
	 -Position.
	 -Position#
	 -Position().
	 -scala/Predef.Position.
	 -scala/Predef.Position#
	 -scala/Predef.Position().
offset: 531
uri: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(3).scala
text:
```scala
package amyc.lsp
...
import org.eclipse.lsp4j.Positi@@on as LSP4JPosition
  ...
  */
  ...
  { 
      ...
      val character = params.getPosition().getCharacter()
          ...
          val identifierPosition: AmyPosition = new SourcePosition(new File(uri), line + 1, offset + 1)
          var definitionPosition: AmyPosition = new SourcePosition(new File(uri), 0, 0)
