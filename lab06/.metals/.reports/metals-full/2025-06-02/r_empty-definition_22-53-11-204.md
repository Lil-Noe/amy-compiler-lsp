error id: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service.scala:`<none>`.
file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service.scala
...
non-local guesses:
	 ...
	 -ju/Collections#
	 -ju/Collections().
	 -amyc/utils/Collections.
	 -amyc/utils/Collections#
	 -amyc/utils/Collections().
	 -amyc/parsing/Collections.
	 -amyc/parsing/Collections#
	 -amyc/parsing/Collections().
	 -amyc/analyzer/Collections.
	 -amyc/analyzer/Collections#
	 -amyc/analyzer/Collections().
	 -amyc/ast/SymbolicTreeModule.Collections.
	 -amyc/ast/SymbolicTreeModule.Collections#
	 -amyc/ast/SymbolicTreeModule.Collections().
	 -Collections.
	 -Collections#
	 -Collections().
	 -scala/Predef.Collections.
	 -scala/Predef.Collections#
	 -scala/Predef.Collections().
offset: 636
uri: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service.scala
text:
```scala
package amyc.lsp
