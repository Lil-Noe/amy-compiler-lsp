error id: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(4).scala:`<none>`.
file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(4).scala
...
non-local guesses:
	 ...
	 -amyc/utils/Location#
	 -amyc/utils/Location().
	 -amyc/parsing/Location.
	 -amyc/parsing/Location#
	 -amyc/parsing/Location().
	 -amyc/analyzer/Location.
	 -amyc/analyzer/Location#
	 -amyc/analyzer/Location().
	 -amyc/ast/SymbolicTreeModule.Location.
	 -amyc/ast/SymbolicTreeModule.Location#
	 -amyc/ast/SymbolicTreeModule.Location().
	 -Location.
	 -Location#
	 ...
	 -scala/Predef.Location().
offset: 454
uri: file://<WORKSPACE>/src/amyc/lsp/Text%20Document%20Service%20(4).scala
text:
```scala
package amyc.lsp
...
import org.eclipse.lsp4j.Loc@@ation
  ...
  */
  ...
  { 
      ...
      val character = params.getPosition().getCharacter()
          ...
          val identifierPosition: Position = new SourcePosition(new File(uri), line + 1, offset + 1)
          var definitionPosition: Position = new SourcePosition(new File(uri), 0, 0)
      ...
      // Get path of file
      //val path = Paths.get(URI.create(uri)).toFile

      //val ctx = new Context(new Reporter, List(path.getPath))
      ...
      /*val definitionFileURI = definitionPosition.file.getPath().toUri.toString()
      ...
      val inituri: String = uri0.slice(0, uri0.indexOf("Users") - 1)
                val location: Optional[Location] = Optional.of(new Location(inituri + definitionPosition.file.toString(), range))
