...
This document is the specification of Amy. Its purpose is to help clearly understand what an Amy program means, and to be the Amy language reference, along with the reference compiler.

**Note**: This specification is accurate as of May of 2025.
